...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__upper_first__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__identity__ = __webpack_require__(10);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_smooth_dnd__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bootstrap_vue_es_components_alert_alert__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bootstrap_vue_es_components_button_button__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_bootstrap_vue_es_components_card_card__ = __webpack_require__(34);
//
//
//
//
...
const scene = {
  ...
  children: Object(__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* generateItems */])(3, i => ({
    id: `column${i}`,
    type: "container",
    name: columnNames[i],
    props: {
    ...
    children: Object(__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* generateItems */])(+(Math.random() * 10).toFixed() + 5, j => ({
      type: "draggable",
      id: `${i}${j}`,
      props: {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  name: "app",
  components: {
    Container: __WEBPACK_IMPORTED_MODULE_0_vue_smooth_dnd__["Container"],
    Draggable: __WEBPACK_IMPORTED_MODULE_0_vue_smooth_dnd__["Draggable"],
    "b-alert": __WEBPACK_IMPORTED_MODULE_2_bootstrap_vue_es_components_alert_alert__["a" /* default */],
    "b-btn": __WEBPACK_IMPORTED_MODULE_3_bootstrap_vue_es_components_button_button__["a" /* default */],
    "b-card": __WEBPACK_IMPORTED_MODULE_4_bootstrap_vue_es_components_card_card__["a" /* default */]
  },
  data() {
    return {
      dismissSecs: 5,
...
function pluckProps(keysToPluck, objToPluck) {
  ...
  return (Object(__WEBPACK_IMPORTED_MODULE_1__array__["d" /* isArray */])(keysToPluck) ? keysToPluck.slice() : Object(__WEBPACK_IMPORTED_MODULE_0__object__["b" /* keys */])(keysToPluck)).reduce(function (memo, prop) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5fe296aa_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(42);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5fe296aa_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
...
var update = __webpack_require__(19)("1ece44a2", content, true, {});
...
/* harmony export (immutable) */ __webpack_exports__["a"] = applyDrag;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = generateItems;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__alert_css__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_functional_data_merge__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_pluck_props__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_array__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_object__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_dom__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__link_link__ = __webpack_require__(33);
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var linkPropKeys = Object(__WEBPACK_IMPORTED_MODULE_3__utils_object__["b" /* keys */])(linkProps);
...
function handleFocus(evt) {
  if (evt.type === 'focusin') {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_4__utils_dom__["b" /* removeClass */])(evt.target, 'focus');
  }
}
...
function pickLinkProps(propsToPick) {
  ...
  return Object(__WEBPACK_IMPORTED_MODULE_0__utils_object__["b" /* keys */])(freshLinkProps).reduce(function (memo, prop) {
...
function omitLinkProps(propsToOmit) {
  ...
  return Object(__WEBPACK_IMPORTED_MODULE_0__utils_object__["b" /* keys */])(props).reduce(function (memo, prop) {
...
var computed = {
  linkProps: function linkProps() {
    var linkProps = {};
    var propKeys = Object(__WEBPACK_IMPORTED_MODULE_0__utils_object__["b" /* keys */])(props);
...
/* unused harmony export props */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_functional_data_merge__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_prefix_prop_name__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_unprefix_prop_name__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_copyProps__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_pluck_props__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_object__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__mixins_card_mixin__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lower_first__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_functional_data_merge__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_prefix_prop_name__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_copyProps__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_object__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mixins_card_mixin__ = __webpack_require__(5);
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Container',{staticClass:"row",attrs:{"orientation":"horizontal","drag-handle-selector":".column-drag-handle"},on:{"drop":function($event){_vm.onColumnDrop($event)},"drag-start":_vm.dragStart}},_vm._l((_vm.scene.children),function(column){return _c('Draggable',{key:column.id,staticClass:"col-md-4 col-xs-12"},[_c('div',{class:column.props.className},[_c('div',{staticClass:"card-column-header card-header bg-primary"},[_c('span',{staticClass:"column-drag-handle",staticStyle:{"color":"white"}},[_vm._v("☰")]),_vm._v(" "),_c('span',{staticStyle:{"color":"white"}},[_vm._v(_vm._s(column.name))])]),_vm._v(" "),_c('Container',{attrs:{"group-name":"col","get-child-payload":_vm.getCardPayload(column.id),"drag-class":"card-ghost","drop-class":"card-ghost-drop"},on:{"drop":function (e) { return _vm.onCardDrop(column.id, e); },"drag-start":function (e) { return _vm.log('drag start', e); },"drag-end":function (e) { return _vm.log('drag end', e); }}},_vm._l((column.children),function(card){return _c('Draggable',{key:card.id},[_c('div',{class:card.props.className,style:(card.props.style)},[_c('div',{staticClass:"card-header"},[_vm._v("Header")]),_vm._v(" "),_c('div',{staticClass:"card-body"},[_c('p',{staticClass:"card-text"},[_vm._v("\n                      "+_vm._s(card.data)+"\n                    ")])])])])}))],1)])}))],1)}
var staticRenderFns = []
